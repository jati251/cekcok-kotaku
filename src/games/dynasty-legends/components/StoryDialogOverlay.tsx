...
export const StoryDialogOverlay: React.FC<StoryDialogOverlayProps> = ({ dialogs, onComplete }) => {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="absolute inset-0 pointer-events-auto z-40 flex flex-col justify-end p-6 bg-slate-950/40 backdrop-blur-[2px]"
    >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="flex items-start gap-4">
              {/* Officer Portrait with spring animation */}
              <motion.div
