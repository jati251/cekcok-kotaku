...
export const PROPERTIES: Property[] = [
  ...
  { id: 'tree-court', side: -1, start: -3, width: 8, height: 6.0, depth: 6, setback: 3, photos: [1, 3] },
  { id: 'pale-green', side: -1, start: 5, width: 6, height: 5.5, depth: 6, setback: 2.1, photos: [5] },
  { id: 'cream-carport', side: -1, start: 11, width: 7, height: 6, depth: 6, setback: 3.4, photos: [5] },
  { id: 'pine-court', side: -1, start: 18, width: 6, height: 3, depth: 6, setback: 3.5, photos: [5, 7] },
...
export const PHOTO_VIEWS: { photo: number; label: string; eye: [number, number, number]; target: [number, number, number] }[] = [
  ...
  { photo: 2, label: 'White corner house', eye: [1.1, 2.3, 2], target: [-5, 2.5, 2] },
  { photo: 3, label: 'White balcony and tree court', eye: [-1, 2.4, 1], target: [5, 3.2, 1] },
  { photo: 4, label: 'Green house and orange tank', eye: [1.1, 2.5, 14], target: [-5, 2.5, 14] },
  { photo: 5, label: 'Cream carport and pale-green house', eye: [-1, 2.3, 14], target: [5, 3, 14] },
  { photo: 6, label: 'Turquoise house', eye: [1.1, 2.3, 22], target: [-5, 2.7, 22] },
  { photo: 7, label: 'Blue house and flower garden', eye: [-1, 2.2, 27], target: [5, 2.2, 27] },
  { photo: 8, label: 'Yellow house and black gate', eye: [-1, 2.2, 36], target: [5, 2.8, 36] },
  { photo: 9, label: 'Gray house and vine wall', eye: [1.1, 2.2, 29.5], target: [-5, 2.1, 29.5] },
  { photo: 10, label: 'White car and laundry', eye: [-1, 2.2, 45], target: [5, 2.1, 45] },
  { photo: 11, label: 'Low house and open yard', eye: [1.1, 2.2, 39.5], target: [-5, 2, 39.5] },
  { photo: 12, label: 'Green car and lattice gate', eye: [-1, 2.3, 59], target: [5, 2.2, 59] },
  { photo: 13, label: 'Pink tiled house and balcony', eye: [1.1, 2.3, 51], target: [-5, 3.7, 51] },
